...
namespace FBTarjeta.Controllers
{
    ...
    {
        private readonly AplicationDbContext _context; //una aplicacion de solo lectura de tipo aplicationdebcontext llamada _context

        public TarjetaController(AplicationDbContext context)
        { //creamos un constructor e inyectamos el contexto
